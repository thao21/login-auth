    ...
    <section class="login-wrapper">
      <div class="container">
        <form @submit.prevent="handleLogin" class="form-auth">
          ...
          <div class="error-mess" v-show="[hasErrorMessage != null]">
    ...
    handleLogin() {
      ...
      this.$store.dispatch('login', request)
       .then(() => {
         ...
         this.hasErrorMessage = err.message;
       });
